...
np1=400;
Ytrn1 = [housing_data(1 : np1, 1:p) ones(np1,1)];
Ytst1 = [housing_data(np1 + 1: N,1:p) ones(N-np1,1)];
ftrn1 = housing_data(1 : np1, p1);
ftst1 = housing_data(np1 + 1 : N, p1);
...
% Etrn1 = ((norm(Ytst1*wtrn1-ftst1))^2)/(N-np1);
% % end
% % xx = 1:1:500;
% % figure(3),clf,
