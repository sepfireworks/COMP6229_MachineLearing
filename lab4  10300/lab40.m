...
for i = 0:9
    ...
    Etrn0(i+1) = ((norm(Ytrn*wtrn-ftrn))^2)/(N-np);
    Etst(i+1) = ((norm(Ytst*wtst-ftst))^2)/np;
end
avgEtrn = sum(Etrn)/10;
avgEtst = sum(Etst)/10;
ET = [Etrn Etst Etrn0];
